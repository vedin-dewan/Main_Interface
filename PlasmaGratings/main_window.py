...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Plasma Gratings GUI")
        self.resize(920, 720)

        motors = [
            MotorInfo("PRB",  "Probe Delay",     0,        0.0,      "mm", 360.0, 0.0, 360.0, 90.0, "mm/s"),
            MotorInfo("PMP",  "Pump Delay",       4_266_667, 203.2,   "mm", 304.8, 0.0, 304.8, 50.0, "mm/s"),
            MotorInfo("IFR",  "Interfere Delay",       1_066_667, 50.8,    "mm", 304.8, 0.0, 304.8, 50.0, "mm/s")
